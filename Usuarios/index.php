...
<body style="background-color: #FDF8E2; font-family: 'Fredoka', sans-serif; color: #504E76;">
    ...
    <?php if (isset($_SESSION['mensaje_alerta'])): ?>
        <div class="alert alert-success alert-dismissible fade show position-absolute top-0 start-50 translate-middle-x mt-4 shadow-sm"
            role="alert"
            style="z-index: 9999; background-color: #E6D8B8; border-color: #C06C38; color: #504E76; font-weight: 500;">
            <?php
    ...
    <div id="cinta-dolar" class="text-center py-1 shadow-sm"
        style="background-color: #8D4A23; color: #FDF8E2; font-size: 0.85rem; font-weight: 500; letter-spacing: 0.5px; z-index: 1000; position: relative;">
        <span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"
            style="width: 0.8rem; height: 0.8rem;"></span> Cargando tasa del día...
    </div>

    <nav class="navbar navbar-expand-lg shadow-sm" style="background-color: #504E76; padding: 15px 0;">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.php"
                style="font-family: 'Righteous', sans-serif; color: #FDF8E2; font-size: 1.8rem; letter-spacing: 1px;">
            ...
            <div class="collapse navbar-collapse" id="navbarContenido">
                <form id="searchForm" class="d-flex mx-auto my-2 my-lg-0 w-100" action="index.php" method="GET"
                    ...
                    <button class="btn text-white fw-medium shadow-sm px-4" type="submit"
                        style="background-color: #C06C38;" onmouseover="this.style.backgroundColor='#8D4A23'"
                        onmouseout="this.style.backgroundColor='#C06C38'">Buscar</button>
                </form>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    <li class="nav-item dropdown me-3 mb-2 mb-lg-0">
                        ...
                        <ul class="dropdown-menu border-0 shadow-sm" style="background-color: #FDF8E2;">
                            <li><a class="dropdown-item fw-medium" href="index.php" style="color: #504E76;"
                                    onmouseover="this.style.backgroundColor='#E6D8B8'"
                                    onmouseout="this.style.backgroundColor='transparent'">Todas</a></li>
                            <?php
                            $res_categorias = $conn->query("SELECT * FROM categorias");
                            while ($cat = $res_categorias->fetch_assoc()):
                                ?>
                                <li><a class="dropdown-item fw-medium" href="index.php?categoria=<?php echo $cat['id']; ?>"
                                        style="color: #504E76;" onmouseover="this.style.backgroundColor='#E6D8B8'"
                                        onmouseout="this.style.backgroundColor='transparent'"><?php echo htmlspecialchars($cat['nombre_categoria']); ?></a>
                                </li>
                            <?php endwhile; ?>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item me-2 mb-2 mb-lg-0">
                        ...
                        ?>
                        <a class="btn text-white fw-medium shadow-sm px-3" href="carrito/carrito.php"
                            style="background-color: #C06C38;" onmouseover="this.style.backgroundColor='#8D4A23'"
                            onmouseout="this.style.backgroundColor='#C06C38'">
                            🛒 Carrito
                            <?php echo $total_carrito > 0 ? "<span class='badge bg-light text-dark ms-1'>$total_carrito</span>" : ""; ?>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="btn shadow-sm px-4 fw-medium" href="perfil/perfil.php"
                            style="background-color: #E6D8B8; color: #504E76;"
                            onmouseover="this.style.backgroundColor='#FDF8E2'; this.style.color='#8D4A23';"
                            onmouseout="this.style.backgroundColor='#E6D8B8'; this.style.color='#504E76';">Mi Perfil</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container my-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4" id="catalogoGrid">
                ...
                <?php while ($row = $resultado->fetch_assoc()): ?>
                    <div class="col">
                        <div class="card h-100 shadow-sm border-0 rounded-3" style="border: 2px solid #E6D8B8 !important;">
                            ...
                            <img src="<?php echo $row['imagen_portada']; ?>" class="card-img-top"
                                alt="Portada de <?php echo $row['nombre_producto']; ?>"
                                style="height: 250px; object-fit: cover; background-color: #E6D8B8; border-bottom: 2px solid #E6D8B8;">
            ...
            <?php else: ?>
                <div class="col-12 text-center py-5">
                    <h4 style="color: #8D4A23;">No encontramos vinilos en esta búsqueda/categoría.</h4>
                    <a href="index.php" class="btn text-white mt-3 px-4 py-2 fw-medium"
                        style="background-color: #C06C38;">Ver todo el catálogo</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
